Vue.component('w-footer', {
    template: ` <div class="container-fluid cst_sectionBlock c-section cbsect_33626058" data-c_tl_id="tl_70ca589a" id="sectiondd723e9c">
        ...
        <div class="c-div div_gcQ0Hq">
            <div class="cst_footer_copyright c-div cbdiv_55603246">
                <div class="cst_textLinkstyle cst_flex_between c-div cbdiv_8870194d">
                    <div class="c-div cs-repeatable c-initHide cbdiv_0d497597" data-c_ani_id="ani_96e4d764c4182f65">
                        <p class="c-paragraph cbpara_a6ba252b">
                            © 2017 旅游展示类模版 - ChenhuiGT. All Rights Reserved.
                        </p>
                        <p class="hidden-sm hidden-xs c-paragraph cbpara_a6ba252b">
                            本网页素材源自素材网站，如有侵权请联系客服.
                        </p>
                        <p class="hidden-xs c-paragraph cbpara_db0e6394">
                            技术支持：
                        </p>
                        <a class="hidden-xs c-textlink cbtext_51dfd806" href="/" target="_blank">
                            上海意派
                        </a>
                    </div>
                </div>
